    ...
    <div class="layout-content">
      <Form ref="formValidate" :model="formValidate" :rules="ruleValidate">
        ...
        <Row :gutter="20">
          ...
          <Col span="9">
          <FormItem label="换算公式" prop="dosageNumber" class='conversionFormula'>
            <span class='dismantlingUnit'>1拆零单位=</span>
            <Input v-model="formValidate.dosageNumber"></Input>
            <span class='doseUnit'>剂量单位</span>
          </FormItem>
          </Col>
        </Row>
        <Row :gutter="20">
          <Col span="9">
          <FormItem label="药品分类">
            <medicineClassify v-on:giveMedicineClassify='getMedicineClassify' v-bind:classifications="formValidate.classifications" />
          </FormItem>
          </Col>
          <Col span="9">
        ...
        <Row :gutter="20">
          <Col span="9">
          <FormItem label="默认频次" prop="dosageFrequencyType">
            <Select v-model="formValidate.dosageFrequencyType">
              <Option :value='key' v-for='(value,key) in formValidate.frequencyOfUsages' :key="key">{{ value }}</Option>
            </Select>
          </FormItem>
          </Col>
          <Col span="9">
        ...
        <Row :gutter="20">
          ...
          <Col span="9">
          <FormItem label="国际编码">
            <Input v-model="formValidate.detail.code"></Input>
          </FormItem>
          </Col>
        </Row>
        <Row :gutter="20">
          ...
          <Col span="9">
          <FormItem label="是否需要皮试">
            <Select v-model="formValidate.skinTest">
